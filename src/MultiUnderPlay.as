...
APatchSet@ GetMenuPatches() {
    ...
    <frameinstance
		...
		pos="-82.5943 35.37"
		z-index="1"
		data-text="Multiplayer"
		data-supersample="1"
		data-styles="component-trackmania-expendable-button-style-stack expendable-button-style-stack-homepage"
